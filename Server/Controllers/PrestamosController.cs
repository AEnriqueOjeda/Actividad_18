...
namespace Actividad_18.Server.Controllers
{
    ...
    public class PrestamosController : ControllerBase
    {
        ...
        public PrestamosController(BibliotecaContexto context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Prestamos>> GetPrestamos(int id)
        {
            ...
            var prestamos = await _context.Prestamos.Include(p => p.Usuario).Include(p => p.Libro
        ...
        public async Task<ActionResult<Prestamos>> PostPrestamos(Prestamos prestamos)
        {
            if (_context.Prestamos == null)
            {
                return Problem("Entity set 'BibliotecaContexto.Prestamos' is null.");
            }
