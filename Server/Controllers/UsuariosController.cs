...
namespace Actividad_18.Server.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuarios>> PostUsuarios(Usuarios usuarios)
        {
            if (_context.Usuarios == null)
            {
                return Problem("Entity set 'BibliotecaContexto.Usuarios' is null.");
            }
        ...
        public async Task<IActionResult> DeleteUsuarios(int? id)
        {
            ...
            if (usuario.Prestamos != null && usuario.Prestamos.Any())
            {
                ...
                var libros = await _context.Libros.Where(l => prestamosIds.Contains((int)l.PrestamosId)).ToListAsync();
